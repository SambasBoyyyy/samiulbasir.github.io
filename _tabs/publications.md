...
- **Neural Network Optimization**: Developing efficient pruning and compression techniques
- **Large Language Models**: Post-training optimization and deployment strategies
- **Model Efficiency**: Creating practical solutions for resource-constrained environments
- **AI Integration**: Model Context Protocol (MCP) and AI system integration
...
- Novel pruning and compression techniques

Feel free to reach out if you'd like to discuss potential collaborations or have questions about my research work.
